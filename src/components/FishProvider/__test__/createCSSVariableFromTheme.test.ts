...
describe('createCSSVariableFromTheme', () => {
    it('when theme is undefined, should return the correct css variable', () => {
        expect(createCSSVariableFromTheme('.selector', undefined)).toBe('.selector{ }');
    });
    it('should return the correct css variable', () => {
        ...
        expect(createCSSVariableFromTheme('.selector', cssVariable)).toBe('.selector{ --colorBackgroundOverlay: red; --borderRadiusMedium: 10px; }');
    });
});